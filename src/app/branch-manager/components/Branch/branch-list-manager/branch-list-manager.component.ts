...
@Component({
  selector: 'app-branch-list-manager',
  templateUrl: './branch-list-manager.component.html',
  styleUrls: ['./branch-list-manager.component.scss']
})
export class BranchListManagerComponent implements OnInit{
